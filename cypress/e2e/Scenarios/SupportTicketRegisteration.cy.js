...
describe('Register  support ticket', () => {
    it('should register successfully', () => {
        ...
        cy.wait(6000);
         ...
         cy.wait(2000);
         cy.dataCy("above-tables-btn").click()
         cy.wait(3000)
        ...
        cy.wait(3000);
        //let a = cy.get('.ChatBox_wrapperChatSection__LZOLw > div > .text-sm').text;
        //console.log(a);
        
        cy.get(".text-sm font-medium text-white").should('have.text',ticketdesc);
        // cy.get(".text-sm font-medium text-white").contains(ticketdesc)
